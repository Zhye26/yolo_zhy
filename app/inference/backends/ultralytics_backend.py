...
class UltralyticsBackend(DetectorBackend):
    ...
    def load(self, model_path: str) -> None:
        ...
        self._supports_candidate_refine = (
            self._class_names == settings.detection.class_names
            and not settings.detection.ebike_only_mode
        )
    ...
    def _enabled_detection_class_ids(self) -> List[int]:
        if settings.detection.ebike_only_mode:
            return [settings.detection.ebike_class_id]
